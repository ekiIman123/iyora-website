...
const OLYMPIADS: Olympiad[] = [
  ...
  },
  {
    ...
    participants: "sma",
    format: "online",
    url: "https://www.iygo-iysa.or.id",
  },
  {
    id: "iyeo",
    name: "IYEO",
    full: "International Youth Environmental Olympiad",
    icon: "🌱",
    level: "international",
    participants: "sma",
    format: "online",
  ...
  },
  {
    id: "os2mn",
    name: "OS2MN",
    full: "Olimpiade Sains Siswa Madrasah Nasional",
    icon: "🕌",
    level: "madrasah",
    participants: "mi_ma",
    format: "online",
    url: "https://www.os2mn.or.id",
  },
  {
    id: "wso",
    name: "WSO",
          ...
          {filtered.map((olympiad) => (
            ...
            >
              ...
              <div className="p-6 flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 flex-wrap mb-1">
                    ...
                    <span
                      className={`text-xs px-2.5 py-0.5 rounded-full font-semibold uppercase tracking-wide ${LEVEL_BADGE_STYLES[olympiad.level]}`}
                    >
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="bg-gray-50 rounded-xl p-3">
                    ...
                    <p className="text-sm font-semibold text-gray-700">
                      {t(olympiad.participants as Parameters<typeof t>[0])}
                    </p>
                  </div>
                  <div className="bg-gray-50 rounded-xl p-3">
                    <p className="text-xs text-gray-400 font-medium uppercase tracking-wide mb-1">
                    ...
                    <p className="text-sm font-semibold text-gray-700">
                      {t(olympiad.format as Parameters<typeof t>[0])}
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="p-6 pt-4">
                ...
                >
                  {olympiad.url === "#" ? "Coming Soon" : t("visit_site")}
                </a>
              </div>
            </div>
          ))}
